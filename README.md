...
Query 3 allows managers to see which restaurants have reservations below 30, paired with each maximum occupancy. The restaurants listed all have reservations fair below their occupancy numbers, signifying that they should increase the amount of reservations for more business. As a result, this data can help managers identify which locations lack business and need extra help for a better business model.
